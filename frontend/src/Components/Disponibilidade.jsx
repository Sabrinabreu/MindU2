...
const Disponibilidade = () => {
    ...
    const handleDateSelect = (date) => {
        ...
        // Aqui você pode adicionar lógica para buscar eventos para a data selecionada
    };
    ...
    const handleUpdate = () => {
        ...
        if (!selectedDate) {
            alert('Por favor, selecione uma data antes de atualizar.');
            return;
        }
                        ...
                        <Row className="mb-3 g-3">
                            {daysOfWeek.map((day, index) => (
                                <Col key={index} md={2}>
                                    ...
                                    {selectedDays[day] && (
                                        <>
                                            <Form.Group controlId={`formBasic Start${day}`}>

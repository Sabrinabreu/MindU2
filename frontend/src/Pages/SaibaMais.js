...
const Agendar = () => { 
    ...
    const fetchDisponibilidades = async (psicologoId) => { 
        try { 
            ...
            const data = await response.json(); // Use json() para obter diretamente o JSON 
    ...
    const renderAvailableTimes = () => { 
        ...
        const timesForSelectedDate = availableTimes[formattedDate] || []; // Filtra horários pela data selecionada 

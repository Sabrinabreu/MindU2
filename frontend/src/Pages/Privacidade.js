      ...
      <BAPO />
        <div>
          ...
          <p>
              ...
              coletar no site 
              <a href="https://MindU.com/"> MindU</a>, e outros sites que possuímos e
              operamos.
          </p>
          <p>
          ...
          <ul>
            ...
            <li> C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do MindU, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
          </ul>
        </div>
      </>
  );

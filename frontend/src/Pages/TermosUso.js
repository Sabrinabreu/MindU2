    ...
    <div>
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          Ao acessar ao site <a href="https://MindU.com/">MindU</a>, concorda
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          ...
          materiais (informações ou software) no site MindU, apenas para
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          ...
          dessas restrições e poderá ser rescindida por MindU a qualquer
      ...
      <ol>
        <li>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            Os materiais no site da MindU são fornecidos 'como estão'. MindU não
        ...
        <li>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            Além disso, o MindU não garante ou faz qualquer representação
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          Em nenhum caso o MindU ou seus fornecedores serão responsáveis ​​por
          ...
          incapacidade de usar os materiais em MindU, mesmo que MindU ou um
          representante autorizado da MindU tenha sido notificado oralmente ou
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          Os materiais exibidos no site da MindU podem incluir erros técnicos,
          tipográficos ou fotográficos. MindU não garante que qualquer material
          em seu site seja preciso, completo ou atual. MindU pode fazer
          alterações nos materiais contidos em seu site a qualquer momento, sem
          aviso prévio. No entanto, MindU não se compromete a atualizar os
          materiais.
        </span>
      </p>
      <h2>
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          O MindU não analisou todos os sites vinculados ao seu site e não é
          responsável pelo conteúdo de nenhum site vinculado. A inclusão de
          qualquer link não implica endosso por MindU do site. O uso de qualquer
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          O MindU pode revisar estes termos de serviço do site a qualquer
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          ...
          leis do MindU e você se submete irrevogavelmente à jurisdição

...
router.post('/agendamentos', async (req, res) => {
    const { psicologo_id, data, horario_inicio, tipo, assunto } = req.body;

    console.log('Dados recebidos:', { psicologo_id, data, horario_inicio, tipo, assunto });
    ...
    try {
        const [result] = await connection.query(
            'INSERT INTO agendamentos (psicologo_id, data, horario_inicio, tipo, assunto) VALUES (?, ?, ?, ?, ?)',
            [psicologo_id, data, horario_inicio, tipo, assunto]
        );
